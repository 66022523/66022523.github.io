    ...
    <section id="about" class="min-h-screen space-y-12 p-4 sm:p-24">
      ...
      <article class="grid grid-cols-2 items-center gap-12">
            ...
            <table>
              <tbody>
                ...
                <tr>
                  <th>วันเกิด</th>
                  <td>
                    12 มกราคม 2548 (<span id="about-age">0</span> ปี)
                  </td>
                </tr>
                <tr>
                  <th>การศึกษา</th>
        ...
        <div class="prose">
          ...
          <p>
            จุดเริ่มต้นของผมอาจจะเกิดมาจากพ่อของผมเองที่เคยแฮ็กชาวบ้านชาวช่องเขาไปเรื่อยอย่างไปขโมยอินเทอร์เน็ตจากข้างบ้านซึ่งถูกล็อคเอามาต่อเร้าเตอร์ของบ้านเพิ่มแล้วใช้ได้จริงเฉย!
          ...
          <blockquote>
            เมื่อก่อนพ่อผมเคยใช้ Back Track (ปัจจุบันเรียกว่า Kali) ด้วยนะ
            พ่อผมบอกว่ามันคือเครื่องมือแฮ็กชั้นดีเลย ผมได้สกิลตรงนี้มาจากพ่อนิดๆ
            หน่อยๆ แต่น่าเสียดายผมลืมมันไปหมดละล่ะสบายใจได้5555
          </blockquote>
        </div>
      </article>
    </section>
